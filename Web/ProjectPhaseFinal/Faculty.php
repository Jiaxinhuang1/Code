...
<body>
    ...
    <div id="top">
        ...
        <a href="themeset.php?choice=Homepage&currentPage=Faculty.php"><button class = "themeBtn">Normal</button></a>
        <a href="themeset.php?choice=HomepageDark&currentPage=Faculty.php"><button class = "themeBtn">Dark</button></a>
    </div>
        ...
        <div id = "facultyRow">
            ...
            <p> <a href="https://designcreativetech.utexas.edu/neal-daugherty">Neal Daugherty</a> </p>
                <ul>
                    ...
                    <li> Courses Taught (2021-2022): AET 306 (Foundations of Digital Imaging and Visualization), AET 319 (Art and Content), AET 324E (Concepts of Visual Style), AET 339 (Motion and Animation, Previously known as Introduction to 2D Animation), AET 339 (Design Studio: â€œGravitivityâ€)
                    </li>
                </ul>
