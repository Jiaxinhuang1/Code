...
<body>
    ...
    <div id="top">
        ...
        <a href="themeset.php?choice=Homepage&currentPage=Homepage.php"><button id = "themeBtn">Normal</button></a>
        <a href="themeset.php?choice=HomepageDark&currentPage=Homepage.php"><button id = "themeBtn">Dark</button></a>
    </div>
