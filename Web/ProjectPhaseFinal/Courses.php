...
<body onload="onLoad()">
    <div id="top">
        ...
        <a href="themeset.php?choice=Homepage&currentPage=Courses.php"><button class = "themeBtn">Normal</button></a>
        <a href="themeset.php?choice=HomepageDark&currentPage=Courses.php"><button class = "themeBtn">Dark</button></a>
    </div>
	...
	<li><a href="Login.php">Log In</a></li>
        ...
        <script>
            ...
            function onLoad(){
                var workArray = new Array("ExampleWork/foundations2.gif", "ExampleWork/mandT1.png", "ExampleWork/foundations3.gif", "ExampleWork/creatingCoding1.PNG", "ExampleWork/ConceptsOVS2.png", "ExampleWork/aetstudio2.png", "ExampleWork/3062.PNG", "ExampleWork/3063.PNG", "ExampleWork/GAP1.png", "ExampleWork/mobileGame2.png", "ExampleWork/techart2.png", "ExampleWork/storyBoard2.PNG")
