...
<body>
    ...
    <div id="top">
        ...
        <a href="themeset.php?choice=Homepage&currentPage=FAQ.php"><button class = "themeBtn">Normal</button></a>
        <a href="themeset.php?choice=HomepageDark&currentPage=FAQ.php"><button class = "themeBtn">Dark</button></a>
    </div>
